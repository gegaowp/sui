...
use crate::types::SuiTransactionResponseWithOptions;
...
impl<S: IndexerStore> ReadApi<S> {
    ...
    async fn get_transaction_with_options_internal(
        ...
        let sui_tx_resp = self
            .state
            .compose_sui_transaction_response(tx, options.clone())
            .await?;
        let sui_transaction_response = SuiTransactionResponseWithOptions {
