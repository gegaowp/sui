...
use crate::types::{CheckpointTransactionResponse, TemporaryTransactionResponseStore};
    ...
    S: IndexerStore + Sync + Send + 'static,
{
    ...
    fn index_checkpoint(
        ...
        let temp_tx_store_iter = transactions
            .iter()
            .map(|tx| TemporaryTransactionResponseStore::from(tx.clone()));
    ...
    fn index_packages(
        transactions: &[CheckpointTransactionResponse],
